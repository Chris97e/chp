...
{% with block_class="costumer-pill" %}
<li class="{{block_class}}{% if add %}{{block_class|modifier:'add'}}{% endif %}">
  ...
  {% else %}
    {% picture image format-{jpeg,webp} width-{56} height-{56} class=block_class|element:'shadow' %}
    {% picture image format-{jpeg,webp} width-{56} height-{56} class=block_class|element:'image' %}
  {% endif %}
</li>
{% endwith %}