...
# @param {string} over: color (Optional)
{% endcomment %}

{% with block_class="icon-button"  %}
  {% if icon %}
    <button class="{{ block_class }}{% if over %}{{ block_class|modifier:over }}{% endif %}{% if no_border %}{{ block_class|modifier:'no-border' }}{% endif %} {% firstof custom_class '' %}">
